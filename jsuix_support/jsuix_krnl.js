...
var conf_defaultmail='me'+'@'+'karthik.sg';
var conf_defaulturl='http://www.karthik.sg';
var os_version='KERNEL CORP';
var os_greeting=' '+os_version+' - The JavaScript virtual OS and terminal application for the web. Edit by: F4L1n.D0c';
...
function krnlLoginDmn(user) {
	...
	if (krnlCurPcs.user) {
		...
		cnslType('  SANTA LINUX WEB OS Version 1.0:Log-on - type user-name (e.g. "guest") and hit <return>.');
