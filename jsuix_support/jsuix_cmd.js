// JS/UIX v0.46
// (c) Alagappan Karthikeyan (www.karthik.sg) 2006
// all rights reserved
...
function commandHelp(env) {
	...
	' ',
	'info                        site information - about %+e-tradition.net%-i',
...
function commandHello(env) {
	...
	var s=' '+os_version+t+'\n';
	s+=' by Alagappan:Karthikeyan - COBRA Softwares Inc., <http://www.karthik.sg>\n';
...
function commandInfo(env) {
	...
	krnlFOut(env.stdout,[
		...
		'                                         dd   ii          ii',
		'               t                         dd         t',
		'  eeeee       tt    rr rrr  aaaaa    ddd dd   ii   tt     ii    eeeee   nn nnn',
		' ee   ee     ttttt  rrr         aa  dd  ddd  iii  ttttt  iii   ee   ee  nnn  nn',
		' eeeeeee  ==  tt    rr      aaaaaa  dd   dd   ii   tt     ii   ee   ee  nn   nn',
		' ee           tt    rr     aa  aaa  dd  ddd   ii   tt     ii   ee   ee  nn   nn',
		'  eeeee        ttt  rr      aaa aa   ddd dd  iiii   ttt  iiii   eeeee   nn   nn',
		'',
		' ----      e  l  e  c  t  r  o  n  i  c      t  r  a  d  i  t  i  o  n     ----%n',
		'                          http://www.karthik.sg%n',
		'                          ** fine bytes & brains **%n%n',
		'                          see also:',
		'                          http://projects.karthik.sg%n%n',
...
function commandFeatures(env) {
	env.stdin=new VfsFileHandle(new VfsFile('p',[
		'%+r System Features %-r',
		os_greeting,
		' by Alagappan:Karthikeyan - COBRA Softwares Inc.,; (c) <http://www.karthik.sg>',
		' ',
		' KERNEL CORP is a virtual terminal and UN*X-like operating system for web browsers.',
		' It is written completely in JavaScript using DHTML for the display.',
		' The current version is v0.1(Feb. 2007).',
		' ',
		' ',
		'%+uFeatures%-u:',
		' ',
		...
		'Irix, Linux, Minix, GNU, etc) or any of its applications. This implementation: is by Karthix from IBM Unix Admin - Genesis Project ',
		'All rights reserved, (c) 2006, JACK Alais Alagappan Karthikeyan, COBRA Software Inc., Singapore',
		' '
	]));
	env.stdin.close();
	env.args=['more'];
...
function manPrintAll() {
	...
	s+='\n\n(c) Alagappan:Karthikeyan 2006; <http://www.karthik.sg>';
	var w=window.open();
...
function sysvarsInit() {
	...
	usrALIAS['etradition']= usrALIAS['electronictradition']=usrALIAS['masswerk']= usrALIAS['mass:werk']='info';
